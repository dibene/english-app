...
| Document | Purpose |
|----------|---------|
| [AGENTS.md](../AGENTS.md) | Full workflow: research, plan, implement, review |
...
2. Read [AGENTS.md](../AGENTS.md) for the step-by-step workflow.
3. Follow AGENTS.md exactly. Do not skip phases.
